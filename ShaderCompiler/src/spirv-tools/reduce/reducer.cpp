...
#include "spirv-tools/reduce/reducer.h"

#include <cassert>
#include <sstream>

#include "spirv-tools/reduce/conditional_branch_to_simple_conditional_branch_opportunity_finder.h"
#include "spirv-tools/reduce/merge_blocks_reduction_opportunity_finder.h"
#include "spirv-tools/reduce/operand_to_const_reduction_opportunity_finder.h"
#include "spirv-tools/reduce/operand_to_dominating_id_reduction_opportunity_finder.h"
#include "spirv-tools/reduce/operand_to_undef_reduction_opportunity_finder.h"
#include "spirv-tools/reduce/remove_block_reduction_opportunity_finder.h"
#include "spirv-tools/reduce/remove_function_reduction_opportunity_finder.h"
#include "spirv-tools/reduce/remove_selection_reduction_opportunity_finder.h"
#include "spirv-tools/reduce/remove_unused_instruction_reduction_opportunity_finder.h"
#include "spirv-tools/reduce/remove_unused_struct_member_reduction_opportunity_finder.h"
#include "spirv-tools/reduce/simple_conditional_branch_to_branch_opportunity_finder.h"
#include "spirv-tools/reduce/structured_construct_to_block_reduction_opportunity_finder.h"
#include "spirv-tools/reduce/structured_loop_to_selection_reduction_opportunity_finder.h"
#include "spirv-tools/spirv_reducer_options.h"
