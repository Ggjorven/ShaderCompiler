...
#include "spirv-tools/fuzz/fuzzer.h"

#include <cassert>
#include <memory>
#include <numeric>

#include "spirv-tools/fuzz/fuzzer_context.h"
#include "spirv-tools/fuzz/fuzzer_pass_add_access_chains.h"
#include "spirv-tools/fuzz/fuzzer_pass_add_bit_instruction_synonyms.h"
#include "spirv-tools/fuzz/fuzzer_pass_add_composite_extract.h"
#include "spirv-tools/fuzz/fuzzer_pass_add_composite_inserts.h"
#include "spirv-tools/fuzz/fuzzer_pass_add_composite_types.h"
#include "spirv-tools/fuzz/fuzzer_pass_add_copy_memory.h"
#include "spirv-tools/fuzz/fuzzer_pass_add_dead_blocks.h"
#include "spirv-tools/fuzz/fuzzer_pass_add_dead_breaks.h"
#include "spirv-tools/fuzz/fuzzer_pass_add_dead_continues.h"
#include "spirv-tools/fuzz/fuzzer_pass_add_equation_instructions.h"
#include "spirv-tools/fuzz/fuzzer_pass_add_function_calls.h"
#include "spirv-tools/fuzz/fuzzer_pass_add_global_variables.h"
#include "spirv-tools/fuzz/fuzzer_pass_add_image_sample_unused_components.h"
#include "spirv-tools/fuzz/fuzzer_pass_add_loads.h"
#include "spirv-tools/fuzz/fuzzer_pass_add_local_variables.h"
#include "spirv-tools/fuzz/fuzzer_pass_add_loop_preheaders.h"
#include "spirv-tools/fuzz/fuzzer_pass_add_loops_to_create_int_constant_synonyms.h"
#include "spirv-tools/fuzz/fuzzer_pass_add_no_contraction_decorations.h"
#include "spirv-tools/fuzz/fuzzer_pass_add_opphi_synonyms.h"
#include "spirv-tools/fuzz/fuzzer_pass_add_parameters.h"
#include "spirv-tools/fuzz/fuzzer_pass_add_relaxed_decorations.h"
#include "spirv-tools/fuzz/fuzzer_pass_add_stores.h"
#include "spirv-tools/fuzz/fuzzer_pass_add_synonyms.h"
#include "spirv-tools/fuzz/fuzzer_pass_add_vector_shuffle_instructions.h"
#include "spirv-tools/fuzz/fuzzer_pass_adjust_branch_weights.h"
#include "spirv-tools/fuzz/fuzzer_pass_adjust_function_controls.h"
#include "spirv-tools/fuzz/fuzzer_pass_adjust_loop_controls.h"
#include "spirv-tools/fuzz/fuzzer_pass_adjust_memory_operands_masks.h"
#include "spirv-tools/fuzz/fuzzer_pass_adjust_selection_controls.h"
#include "spirv-tools/fuzz/fuzzer_pass_apply_id_synonyms.h"
#include "spirv-tools/fuzz/fuzzer_pass_construct_composites.h"
#include "spirv-tools/fuzz/fuzzer_pass_copy_objects.h"
#include "spirv-tools/fuzz/fuzzer_pass_donate_modules.h"
#include "spirv-tools/fuzz/fuzzer_pass_duplicate_regions_with_selections.h"
#include "spirv-tools/fuzz/fuzzer_pass_expand_vector_reductions.h"
#include "spirv-tools/fuzz/fuzzer_pass_flatten_conditional_branches.h"
#include "spirv-tools/fuzz/fuzzer_pass_inline_functions.h"
#include "spirv-tools/fuzz/fuzzer_pass_interchange_signedness_of_integer_operands.h"
#include "spirv-tools/fuzz/fuzzer_pass_interchange_zero_like_constants.h"
#include "spirv-tools/fuzz/fuzzer_pass_invert_comparison_operators.h"
#include "spirv-tools/fuzz/fuzzer_pass_make_vector_operations_dynamic.h"
#include "spirv-tools/fuzz/fuzzer_pass_merge_blocks.h"
#include "spirv-tools/fuzz/fuzzer_pass_merge_function_returns.h"
#include "spirv-tools/fuzz/fuzzer_pass_mutate_pointers.h"
#include "spirv-tools/fuzz/fuzzer_pass_obfuscate_constants.h"
#include "spirv-tools/fuzz/fuzzer_pass_outline_functions.h"
#include "spirv-tools/fuzz/fuzzer_pass_permute_blocks.h"
#include "spirv-tools/fuzz/fuzzer_pass_permute_function_parameters.h"
#include "spirv-tools/fuzz/fuzzer_pass_permute_function_variables.h"
#include "spirv-tools/fuzz/fuzzer_pass_permute_instructions.h"
#include "spirv-tools/fuzz/fuzzer_pass_permute_phi_operands.h"
#include "spirv-tools/fuzz/fuzzer_pass_propagate_instructions_down.h"
#include "spirv-tools/fuzz/fuzzer_pass_propagate_instructions_up.h"
#include "spirv-tools/fuzz/fuzzer_pass_push_ids_through_variables.h"
#include "spirv-tools/fuzz/fuzzer_pass_replace_adds_subs_muls_with_carrying_extended.h"
#include "spirv-tools/fuzz/fuzzer_pass_replace_branches_from_dead_blocks_with_exits.h"
#include "spirv-tools/fuzz/fuzzer_pass_replace_copy_memories_with_loads_stores.h"
#include "spirv-tools/fuzz/fuzzer_pass_replace_copy_objects_with_stores_loads.h"
#include "spirv-tools/fuzz/fuzzer_pass_replace_irrelevant_ids.h"
#include "spirv-tools/fuzz/fuzzer_pass_replace_linear_algebra_instructions.h"
#include "spirv-tools/fuzz/fuzzer_pass_replace_loads_stores_with_copy_memories.h"
#include "spirv-tools/fuzz/fuzzer_pass_replace_opphi_ids_from_dead_predecessors.h"
#include "spirv-tools/fuzz/fuzzer_pass_replace_opselects_with_conditional_branches.h"
#include "spirv-tools/fuzz/fuzzer_pass_replace_parameter_with_global.h"
#include "spirv-tools/fuzz/fuzzer_pass_replace_params_with_struct.h"
#include "spirv-tools/fuzz/fuzzer_pass_split_blocks.h"
#include "spirv-tools/fuzz/fuzzer_pass_swap_commutable_operands.h"
#include "spirv-tools/fuzz/fuzzer_pass_swap_conditional_branch_operands.h"
#include "spirv-tools/fuzz/fuzzer_pass_swap_functions.h"
#include "spirv-tools/fuzz/fuzzer_pass_toggle_access_chain_instruction.h"
#include "spirv-tools/fuzz/fuzzer_pass_wrap_regions_in_selections.h"
#include "spirv-tools/fuzz/fuzzer_pass_wrap_vector_synonym.h"
#include "spirv-tools/fuzz/pass_management/repeated_pass_manager.h"
#include "spirv-tools/fuzz/pass_management/repeated_pass_recommender_standard.h"
#include "spirv-tools/fuzz/protobufs/spirvfuzz_protobufs.h"
#include "spirv-tools/fuzz/transformation_context.h"
#include "spirv-tools/opt/build_module.h"
#include "spirv-tools/spirv_fuzzer_options.h"
