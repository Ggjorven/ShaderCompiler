...
#include "spirv-tools/fuzz/transformation.h"

#include <cassert>

#include "spirv-tools/fuzz/fuzzer_util.h"
#include "spirv-tools/fuzz/transformation_access_chain.h"
#include "spirv-tools/fuzz/transformation_add_bit_instruction_synonym.h"
#include "spirv-tools/fuzz/transformation_add_constant_boolean.h"
#include "spirv-tools/fuzz/transformation_add_constant_composite.h"
#include "spirv-tools/fuzz/transformation_add_constant_null.h"
#include "spirv-tools/fuzz/transformation_add_constant_scalar.h"
#include "spirv-tools/fuzz/transformation_add_copy_memory.h"
#include "spirv-tools/fuzz/transformation_add_dead_block.h"
#include "spirv-tools/fuzz/transformation_add_dead_break.h"
#include "spirv-tools/fuzz/transformation_add_dead_continue.h"
#include "spirv-tools/fuzz/transformation_add_early_terminator_wrapper.h"
#include "spirv-tools/fuzz/transformation_add_function.h"
#include "spirv-tools/fuzz/transformation_add_global_undef.h"
#include "spirv-tools/fuzz/transformation_add_global_variable.h"
#include "spirv-tools/fuzz/transformation_add_image_sample_unused_components.h"
#include "spirv-tools/fuzz/transformation_add_local_variable.h"
#include "spirv-tools/fuzz/transformation_add_loop_preheader.h"
#include "spirv-tools/fuzz/transformation_add_loop_to_create_int_constant_synonym.h"
#include "spirv-tools/fuzz/transformation_add_no_contraction_decoration.h"
#include "spirv-tools/fuzz/transformation_add_opphi_synonym.h"
#include "spirv-tools/fuzz/transformation_add_parameter.h"
#include "spirv-tools/fuzz/transformation_add_relaxed_decoration.h"
#include "spirv-tools/fuzz/transformation_add_spec_constant_op.h"
#include "spirv-tools/fuzz/transformation_add_synonym.h"
#include "spirv-tools/fuzz/transformation_add_type_array.h"
#include "spirv-tools/fuzz/transformation_add_type_boolean.h"
#include "spirv-tools/fuzz/transformation_add_type_float.h"
#include "spirv-tools/fuzz/transformation_add_type_function.h"
#include "spirv-tools/fuzz/transformation_add_type_int.h"
#include "spirv-tools/fuzz/transformation_add_type_matrix.h"
#include "spirv-tools/fuzz/transformation_add_type_pointer.h"
#include "spirv-tools/fuzz/transformation_add_type_struct.h"
#include "spirv-tools/fuzz/transformation_add_type_vector.h"
#include "spirv-tools/fuzz/transformation_adjust_branch_weights.h"
#include "spirv-tools/fuzz/transformation_composite_construct.h"
#include "spirv-tools/fuzz/transformation_composite_extract.h"
#include "spirv-tools/fuzz/transformation_composite_insert.h"
#include "spirv-tools/fuzz/transformation_compute_data_synonym_fact_closure.h"
#include "spirv-tools/fuzz/transformation_duplicate_region_with_selection.h"
#include "spirv-tools/fuzz/transformation_equation_instruction.h"
#include "spirv-tools/fuzz/transformation_expand_vector_reduction.h"
#include "spirv-tools/fuzz/transformation_flatten_conditional_branch.h"
#include "spirv-tools/fuzz/transformation_function_call.h"
#include "spirv-tools/fuzz/transformation_inline_function.h"
#include "spirv-tools/fuzz/transformation_invert_comparison_operator.h"
#include "spirv-tools/fuzz/transformation_load.h"
#include "spirv-tools/fuzz/transformation_make_vector_operation_dynamic.h"
#include "spirv-tools/fuzz/transformation_merge_blocks.h"
#include "spirv-tools/fuzz/transformation_merge_function_returns.h"
#include "spirv-tools/fuzz/transformation_move_block_down.h"
#include "spirv-tools/fuzz/transformation_move_instruction_down.h"
#include "spirv-tools/fuzz/transformation_mutate_pointer.h"
#include "spirv-tools/fuzz/transformation_outline_function.h"
#include "spirv-tools/fuzz/transformation_permute_function_parameters.h"
#include "spirv-tools/fuzz/transformation_permute_phi_operands.h"
#include "spirv-tools/fuzz/transformation_propagate_instruction_down.h"
#include "spirv-tools/fuzz/transformation_propagate_instruction_up.h"
#include "spirv-tools/fuzz/transformation_push_id_through_variable.h"
#include "spirv-tools/fuzz/transformation_record_synonymous_constants.h"
#include "spirv-tools/fuzz/transformation_replace_add_sub_mul_with_carrying_extended.h"
#include "spirv-tools/fuzz/transformation_replace_boolean_constant_with_constant_binary.h"
#include "spirv-tools/fuzz/transformation_replace_branch_from_dead_block_with_exit.h"
#include "spirv-tools/fuzz/transformation_replace_constant_with_uniform.h"
#include "spirv-tools/fuzz/transformation_replace_copy_memory_with_load_store.h"
#include "spirv-tools/fuzz/transformation_replace_copy_object_with_store_load.h"
#include "spirv-tools/fuzz/transformation_replace_id_with_synonym.h"
#include "spirv-tools/fuzz/transformation_replace_irrelevant_id.h"
#include "spirv-tools/fuzz/transformation_replace_linear_algebra_instruction.h"
#include "spirv-tools/fuzz/transformation_replace_load_store_with_copy_memory.h"
#include "spirv-tools/fuzz/transformation_replace_opphi_id_from_dead_predecessor.h"
#include "spirv-tools/fuzz/transformation_replace_opselect_with_conditional_branch.h"
#include "spirv-tools/fuzz/transformation_replace_parameter_with_global.h"
#include "spirv-tools/fuzz/transformation_replace_params_with_struct.h"
#include "spirv-tools/fuzz/transformation_set_function_control.h"
#include "spirv-tools/fuzz/transformation_set_loop_control.h"
#include "spirv-tools/fuzz/transformation_set_memory_operands_mask.h"
#include "spirv-tools/fuzz/transformation_set_selection_control.h"
#include "spirv-tools/fuzz/transformation_split_block.h"
#include "spirv-tools/fuzz/transformation_store.h"
#include "spirv-tools/fuzz/transformation_swap_commutable_operands.h"
#include "spirv-tools/fuzz/transformation_swap_conditional_branch_operands.h"
#include "spirv-tools/fuzz/transformation_swap_function_variables.h"
#include "spirv-tools/fuzz/transformation_swap_two_functions.h"
#include "spirv-tools/fuzz/transformation_toggle_access_chain_instruction.h"
#include "spirv-tools/fuzz/transformation_vector_shuffle.h"
#include "spirv-tools/fuzz/transformation_wrap_early_terminator_in_function.h"
#include "spirv-tools/fuzz/transformation_wrap_region_in_selection.h"
#include "spirv-tools/fuzz/transformation_wrap_vector_synonym.h"
