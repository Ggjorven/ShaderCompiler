...
#include "spirv-tools/opt/cfg.h"
#include "spirv-tools/opt/constants.h"
#include "spirv-tools/opt/debug_info_manager.h"
#include "spirv-tools/opt/decoration_manager.h"
#include "spirv-tools/opt/def_use_manager.h"
#include "spirv-tools/opt/dominator_analysis.h"
#include "spirv-tools/opt/feature_manager.h"
#include "spirv-tools/opt/fold.h"
#include "spirv-tools/opt/liveness.h"
#include "spirv-tools/opt/loop_descriptor.h"
#include "spirv-tools/opt/module.h"
#include "spirv-tools/opt/register_pressure.h"
#include "spirv-tools/opt/scalar_analysis.h"
#include "spirv-tools/opt/struct_cfg_analysis.h"
#include "spirv-tools/opt/type_manager.h"
#include "spirv-tools/opt/value_number_table.h"
#include "spirv-tools/table2.h"
#include "spirv-tools/util/make_unique.h"
#include "spirv-tools/util/string_utils.h"
