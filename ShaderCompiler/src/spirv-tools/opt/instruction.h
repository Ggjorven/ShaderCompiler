...
#include "spirv-tools/binary.h"
#include "spirv-tools/common_debug_info.h"
#include "spirv-tools/latest_version_glsl_std_450_header.h"
#include "spirv-tools/latest_version_spirv_header.h"
#include "spirv-tools/opcode.h"
#include "spirv-tools/operand.h"
#include "spirv-tools/opt/reflect.h"
#include "spirv-tools/util/ilist_node.h"
#include "spirv-tools/util/small_vector.h"
